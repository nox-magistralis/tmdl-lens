...
def generate_html(
    ...
    overview_rows = []
    if config.get("owner"):
        overview_rows.append(["Owner", _esc(config["owner"])])
    if config.get("team"):
        overview_rows.append(["Team", _esc(config["team"])])
    if config.get("refresh_schedule"):
        overview_rows.append(["Refresh Schedule", _esc(config["refresh_schedule"])])
